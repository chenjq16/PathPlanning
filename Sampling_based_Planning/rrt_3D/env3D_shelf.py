...
def getblocks():
    # AABBs
    block = [[5.00e+00, 1.50e+01, 4.00e+00, 15.00e+00, 2.00e+01, 5.00e+00],
             [5.00e+00, 1.50e+01, 14.00e+00, 15.00e+00, 2.00e+01, 15.00e+00],
             [5.00e+00, 1.50e+01, 0.00e+00, 5.50e+00, 1.55e+01, 15.00e+00],
             [14.50e+00, 1.50e+01, 0.00e+00, 15.00e+00, 1.55e+01, 15.00e+00],
             [5.00e+00, 1.95e+01, 0.00e+00, 5.50e+00, 2.00e+01, 15.00e+00],
             [14.50e+00, 1.95e+01, 0.00e+00, 15.00e+00, 2.00e+01, 15.00e+00]
             ]
    Obstacles = []
    for i in block:
        i = np.array(i)
...
def getballs():
    spheres = [[2.0,6.0,2.5,1.0],[14.0,10.0,2.5,2]]
    Obstacles = []
    for i in spheres:
        Obstacles.append([j for j in i])
    return np.array(Obstacles)
...
class env():
    ...
    # def __init__(self, xmin=-5, ymin=0, zmin=-5, xmax=10, ymax=5, zmax=10, resolution=1):  
        ...
        self.goal = np.array([12.0, 17.0, 16.0])
        self.t = 0 # time 
